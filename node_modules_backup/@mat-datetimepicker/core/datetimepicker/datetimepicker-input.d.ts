...
export declare class MatDatetimepickerInputDirective<D> implements AfterContentInit, ControlValueAccessor, OnDestroy, Validator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatDatetimepickerInputDirective<any>, "input[matDatetimepicker]", ["matDatepickerInput"], { "matDatetimepicker": "matDatetimepicker"; "matDatepickerFilter": "matDatepickerFilter"; "value": "value"; "min": "min"; "max": "max"; "disabled": "disabled"; }, { "dateChange": "dateChange"; "dateInput": "dateInput"; }, never, never, false>;
}
