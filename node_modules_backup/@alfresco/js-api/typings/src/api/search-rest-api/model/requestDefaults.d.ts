...
export declare namespace RequestDefaults {
    type DefaultFTSOperatorEnum = 'AND' | 'OR';
    const DefaultFTSOperatorEnum: {
        AND: DefaultFTSOperatorEnum;
        OR: DefaultFTSOperatorEnum;
    };
    type DefaultFTSFieldOperatorEnum = 'AND' | 'OR';
    const DefaultFTSFieldOperatorEnum: {
        AND: DefaultFTSFieldOperatorEnum;
        OR: DefaultFTSFieldOperatorEnum;
    };
}
