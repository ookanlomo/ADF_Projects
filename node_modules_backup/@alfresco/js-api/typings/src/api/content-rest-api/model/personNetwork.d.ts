...
export declare namespace PersonNetwork {
    type SubscriptionLevelEnum = 'Free' | 'Standard' | 'Enterprise';
    const SubscriptionLevelEnum: {
        Free: SubscriptionLevelEnum;
        Standard: SubscriptionLevelEnum;
        Enterprise: SubscriptionLevelEnum;
    };
}
