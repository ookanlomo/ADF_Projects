...
export declare class ProcessScopeRepresentation {
    ...
    activitySidsByActivityIdMap?: {
        [key: string]: string;
    };
    customStencilVariables?: {
        [key: string]: VariableScopeRepresentation;
    };
    entityVariables?: {
        [key: string]: EntityVariableScopeRepresentation;
    };
    executionVariables?: {
        [key: string]: VariableScopeRepresentation;
    };
    ...
    forms?: {
        [key: string]: FormScopeRepresentation;
    };
    metadataVariables?: {
        [key: string]: VariableScopeRepresentation;
    };
    ...
    reusableFieldMapping?: {
        [key: string]: VariableMappingRepresentation;
    };
