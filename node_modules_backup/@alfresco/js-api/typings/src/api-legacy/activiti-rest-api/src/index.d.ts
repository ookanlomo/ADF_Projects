...
export declare const APS_LEGACY_APIS: {
    AlfrescoApi: typeof AlfrescoApiActiviti;
    AboutApi: typeof AboutApi;
    AdminEndpointsApi: typeof AdminEndpointsApi;
    AdminGroupsApi: typeof AdminGroupsApi;
    AdminTenantsApi: typeof AdminTenantsApi;
    AdminUsersApi: typeof AdminUsersApi;
    AppsApi: typeof AppsApi;
    AppsDefinitionApi: typeof AppsDefinitionApi;
    AppsRuntimeApi: typeof AppsRuntimeApi;
    CommentsApi: typeof CommentsApi;
    ContentApi: typeof ContentApi;
    ContentRenditionApi: typeof ContentRenditionApi;
    EditorApi: typeof EditorApi;
    GroupsApi: typeof GroupsApi;
    IDMSyncApi: typeof IDMSyncApi;
    IntegrationAccountApi: typeof IntegrationAccountApi;
    IntegrationAlfrescoCloudApi: typeof IntegrationAlfrescoCloudApi;
    IntegrationAlfrescoOnPremiseApi: typeof IntegrationAlfrescoOnPremiseApi;
    IntegrationBoxApi: typeof IntegrationBoxApi;
    IntegrationDriveApi: typeof IntegrationDriveApi;
    ModelBpmnApi: typeof ModelBpmnApi;
    ModelJsonBpmnApi: typeof ModelJsonBpmnApi;
    ModelsApi: typeof ModelsApi;
    ModelsHistoryApi: typeof ModelsHistoryApi;
    ProcessApi: typeof ProcessApi;
    ProcessDefinitionsApi: typeof ProcessDefinitionsApi;
    ProcessDefinitionsFormApi: typeof ProcessDefinitionsFormApi;
    ProcessInstancesApi: typeof ProcessInstancesApi;
    ProcessInstancesInformationApi: typeof ProcessInstancesInformationApi;
    ProcessInstancesListingApi: typeof ProcessInstancesListingApi;
    ProcessInstanceVariablesApi: typeof ProcessInstanceVariablesApi;
    ProcessScopeApi: typeof ProcessScopeApi;
    ProfileApi: typeof ProfileApi;
    ScriptFileApi: typeof ScriptFileApi;
    SystemPropertiesApi: typeof SystemPropertiesApi;
    TaskApi: typeof TaskApi;
    TaskActionsApi: typeof TaskActionsApi;
    TaskCheckListApi: typeof TaskCheckListApi;
    TaskFormsApi: typeof TaskFormsApi;
    TemporaryApi: typeof TemporaryApi;
    UserApi: typeof UserApi;
    UserFiltersApi: typeof UserFiltersApi;
    UsersWorkflowApi: typeof UsersWorkflowApi;
    ReportApi: typeof ReportApi;
};
export declare namespace Activiti {
    class AlfrescoApi extends _AlfrescoApiActiviti {
    }
    class AboutApi extends _AboutApi {
    }
    class AdminEndpointsApi extends _AdminEndpointsApi {
    }
    class AdminGroupsApi extends _AdminGroupsApi {
    }
    class AdminTenantsApi extends _AdminTenantsApi {
    }
    class AdminUsersApi extends _AdminUsersApi {
    }
    class AppsApi extends _AppsApi {
    }
    class AppsDefinitionApi extends _AppsDefinitionApi {
    }
    class AppsRuntimeApi extends _AppsRuntimeApi {
    }
    class CommentsApi extends _CommentsApi {
    }
    class ContentApi extends _ContentApi {
    }
    class ContentRenditionApi extends _ContentRenditionApi {
    }
    class EditorApi extends _EditorApi {
    }
    class GroupsApi extends _GroupsApi {
    }
    class IDMSyncApi extends _IDMSyncApi {
    }
    class IntegrationAccountApi extends _IntegrationAccountApi {
    }
    class IntegrationAlfrescoCloudApi extends _IntegrationAlfrescoCloudApi {
    }
    class IntegrationAlfrescoOnPremiseApi extends _IntegrationAlfrescoOnPremiseApi {
    }
    class IntegrationBoxApi extends _IntegrationBoxApi {
    }
    class IntegrationDriveApi extends _IntegrationDriveApi {
    }
    class ModelBpmnApi extends _ModelBpmnApi {
    }
    class ModelJsonBpmnApi extends _ModelJsonBpmnApi {
    }
    class ModelsApi extends _ModelsApi {
    }
    class ModelsHistoryApi extends _ModelsHistoryApi {
    }
    class ProcessApi extends _ProcessApi {
    }
    class ProcessDefinitionsApi extends _ProcessDefinitionsApi {
    }
    class ProcessDefinitionsFormApi extends _ProcessDefinitionsFormApi {
    }
    class ProcessInstancesApi extends _ProcessInstancesApi {
    }
    class ProcessInstancesInformationApi extends _ProcessInstancesInformationApi {
    }
    class ProcessInstancesListingApi extends _ProcessInstancesListingApi {
    }
    class ProcessInstanceVariablesApi extends _ProcessInstanceVariablesApi {
    }
    class ProcessScopeApi extends _ProcessScopeApi {
    }
    class ProfileApi extends _ProfileApi {
    }
    class ScriptFileApi extends _ScriptFileApi {
    }
    class SystemPropertiesApi extends _SystemPropertiesApi {
    }
    class TaskApi extends _TaskApi {
    }
    class TaskActionsApi extends _TaskActionsApi {
    }
    class TaskCheckListApi extends _TaskCheckListApi {
    }
    class TaskFormsApi extends _TaskFormsApi {
    }
    class TemporaryApi extends _TemporaryApi {
    }
    class UserApi extends _UserApi {
    }
    class UserFiltersApi extends _UserFiltersApi {
    }
    class UsersWorkflowApi extends _UsersWorkflowApi {
    }
