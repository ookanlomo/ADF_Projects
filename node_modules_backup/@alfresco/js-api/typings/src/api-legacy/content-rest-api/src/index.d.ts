...
export declare const CONTENT_LEGACY_APIS: {
    ChangesApi: typeof ChangesApi;
    ChildAssociationsApi: typeof ChildAssociationsApi;
    FavoritesApi: typeof FavoritesApi;
    NetworksApi: typeof NetworksApi;
    NodesApi: typeof NodesApi;
    CommentsApi: typeof CommentsApi;
    PeopleApi: typeof PeopleApi;
    RatingsApi: typeof RatingsApi;
    RenditionsApi: typeof RenditionsApi;
    QueriesApi: typeof QueriesApi;
    SharedlinksApi: typeof SharedlinksApi;
    SitesApi: typeof SitesApi;
    TagsApi: typeof TagsApi;
    WebscriptApi: typeof WebscriptApi;
    DownloadsApi: typeof DownloadsApi;
    VersionsApi: typeof VersionsApi;
    ClassesApi: typeof ClassesApi;
    GroupsApi: typeof GroupsApi;
    CustomModelApi: typeof CustomModelApi;
};
export declare namespace Core {
    class ChangesApi extends _ChangesApi {
    }
    class ChildAssociationsApi extends _ChildAssociationsApi {
    }
    class FavoritesApi extends _FavoritesApi {
    }
    class NetworksApi extends _NetworksApi {
    }
    class NodesApi extends _NodesApi {
    }
    class CommentsApi extends _CommentsApi {
    }
    class PeopleApi extends _PeopleApi {
    }
    class RatingsApi extends _RatingsApi {
    }
    class RenditionsApi extends _RenditionsApi {
    }
    class QueriesApi extends _QueriesApi {
    }
    class SharedlinksApi extends _SharedlinksApi {
    }
    class SitesApi extends _SitesApi {
    }
    class TagsApi extends _TagsApi {
    }
    class WebscriptApi extends _WebscriptApi {
    }
    class DownloadsApi extends _DownloadsApi {
    }
    class VersionsApi extends _VersionsApi {
    }
    class ClassesApi extends _ClassesApi {
    }
    class GroupsApi extends _GroupsApi {
    }
    class CustomModelApi extends _CustomModelApi {
    }
}
