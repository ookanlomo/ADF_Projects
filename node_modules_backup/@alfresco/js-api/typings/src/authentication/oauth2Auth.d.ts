...
export declare class Oauth2Auth extends AlfrescoApiClient {
    ...
    private refreshTokenIntervalPolling;
    private refreshTokenTimeoutIframe;
    ...
    pollingRefreshToken(): void;
    /**
     * Refresh the  Token
     * */
    refreshToken(): Promise<any>;
    universalBtoa(stringToConvert: string): any;
    /**
