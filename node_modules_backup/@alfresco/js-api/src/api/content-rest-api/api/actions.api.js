...
class ActionsApi extends base_api_1.BaseApi {
    actionDetails(actionDefinitionId) {
        (0, assert_1.throwIfNotDefined)(actionDefinitionId, 'actionDefinitionId');
        const postBody = null;
        const pathParams = {
    ...
    actionExec(actionBodyExec) {
        (0, assert_1.throwIfNotDefined)(actionBodyExec, 'actionBodyExec');
...
//# sourceMappingURL=../../../../../src/api/content-rest-api/api/actions.api.js.map