...
class RenditionsApi extends base_api_1.BaseApi {
    ...
    getRenditionContent(nodeId, renditionId, opts) {
        ...
        return this.apiClient.callApi('/nodes/{nodeId}/renditions/{renditionId}/content', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, 'blob');
    }
    ...
    requestDirectAccessUrl(nodeId, renditionId) {
        (0, assert_1.throwIfNotDefined)(nodeId, 'nodeId');
        (0, assert_1.throwIfNotDefined)(renditionId, 'renditionId');
        const pathParams = {
            'nodeId': nodeId,
        ...
        const contentTypes = ['application/json'];
        const accepts = ['application/json'];
        return this.apiClient.callApi('/nodes/{nodeId}/renditions/{renditionId}/request-direct-access-url', 'POST', pathParams, {}, {}, {}, null, contentTypes, accepts, directAccessUrlEntry_1.DirectAccessUrlEntry);
    }
}
exports.RenditionsApi = RenditionsApi;
//# sourceMappingURL=../../../../../src/api/content-rest-api/api/renditions.api.js.map