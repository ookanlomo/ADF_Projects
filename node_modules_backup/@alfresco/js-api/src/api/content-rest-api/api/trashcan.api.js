...
class TrashcanApi extends base_api_1.BaseApi {
    ...
    requestDirectAccessUrl(nodeId) {
        ...
        const contentTypes = ['application/json'];
        const accepts = ['application/json'];
        return this.apiClient.callApi('/deleted-nodes/{nodeId}/request-direct-access-url', 'POST', pathParams, {}, {}, {}, null, contentTypes, accepts, directAccessUrlEntry_1.DirectAccessUrlEntry);
    }
    requestRenditionDirectAccessUrl(nodeId, renditionId) {
        ...
        const contentTypes = ['application/json'];
        const accepts = ['application/json'];
        return this.apiClient.callApi('/deleted-nodes/{nodeId}/renditions/{renditionId}/request-direct-access-url', 'POST', pathParams, {}, {}, {}, null, contentTypes, accepts, directAccessUrlEntry_1.DirectAccessUrlEntry);
    }
}
