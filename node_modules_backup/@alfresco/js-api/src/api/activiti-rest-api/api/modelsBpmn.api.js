...
exports.ModelsBpmnApi = void 0;
const base_api_1 = require("./base.api");
const assert_1 = require("../../../assert");
class ModelsBpmnApi extends base_api_1.BaseApi {
    getHistoricProcessModelBpmn20Xml(processModelId, processModelHistoryId) {
        (0, assert_1.throwIfNotDefined)(processModelId, 'processModelId');
        (0, assert_1.throwIfNotDefined)(processModelHistoryId, 'processModelHistoryId');
        let postBody = null;
        let pathParams = {
...
//# sourceMappingURL=../../../../../src/api/activiti-rest-api/api/modelsBpmn.api.js.map