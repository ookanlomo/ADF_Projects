...
exports.DecisionAuditRepresentation = void 0;
const dateAlfresco_1 = require("../../content-custom-api/model/dateAlfresco");
class DecisionAuditRepresentation {
    constructor(input) {
        if (input) {
...
//# sourceMappingURL=../../../../../src/api/activiti-rest-api/model/decisionAuditRepresentation.js.map