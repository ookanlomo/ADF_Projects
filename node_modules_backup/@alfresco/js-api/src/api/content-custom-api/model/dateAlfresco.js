...
exports.DateAlfresco = void 0;
class DateAlfresco extends Date {
    static parseDate(dateToConvert) {
    ...
    static parseDateTime(dateToConvert) {
    ...
    static parseDateTimeZone(dateToConvert) {
