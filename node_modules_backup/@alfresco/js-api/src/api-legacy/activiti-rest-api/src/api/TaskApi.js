...
const taskActions_api_1 = require("../../../../api/activiti-rest-api/api/taskActions.api");
const comments_api_1 = require("../../../../api/activiti-rest-api/api/comments.api");
const checklists_api_1 = require("../../../../api/activiti-rest-api/api/checklists.api");
const taskForms_api_1 = require("../../../../api/activiti-rest-api/api/taskForms.api");
const tasks_api_1 = require("../../../../api/activiti-rest-api/api/tasks.api");
const content_api_1 = require("../../../../api/activiti-rest-api/api/content.api");
class TaskApi {
    init(alfrescoApi) {
        this.taskactionsApi = new taskActions_api_1.TaskActionsApi(alfrescoApi);
        this.activitiCommentsApi = new comments_api_1.ActivitiCommentsApi(alfrescoApi);
        this.checklistsApi = new checklists_api_1.ChecklistsApi(alfrescoApi);
        this.taskFormsApi = new taskForms_api_1.TaskFormsApi(alfrescoApi);
        this.tasksApi = new tasks_api_1.TasksApi(alfrescoApi);
