...
const appDefinitions_api_1 = require("../../../../api/activiti-rest-api/api/appDefinitions.api");
const runtimeAppDefinitions_api_1 = require("../../../../api/activiti-rest-api/api/runtimeAppDefinitions.api");
class AppsApi {
    init(alfrescoApi) {
        this.runtimeAppDefinitionsApi = new runtimeAppDefinitions_api_1.RuntimeAppDefinitionsApi(alfrescoApi);
        this.appDefinitionsApi = new appDefinitions_api_1.AppDefinitionsApi(alfrescoApi);
    }
...
//# sourceMappingURL=../../../../../../src/api-legacy/activiti-rest-api/src/api/AppsApi.js.map