...
const people_api_1 = require("../../../../api/content-rest-api/api/people.api");
const networks_api_1 = require("../../../../api/content-rest-api/api/networks.api");
const favorites_api_1 = require("../../../../api/content-rest-api/api/favorites.api");
const sites_api_1 = require("../../../../api/content-rest-api/api/sites.api");
const preferences_api_1 = require("../../../../api/content-rest-api/api/preferences.api");
const activities_api_1 = require("../../../../api/content-rest-api/api/activities.api");
const groups_api_1 = require("../../../../api/content-rest-api/api/groups.api");
class PeopleApi {
    init(alfrescoApi) {
        this.networksApi = new networks_api_1.NetworksApi(alfrescoApi);
        this.peopleApiNew = new people_api_1.PeopleApi(alfrescoApi);
        this.favoritesApi = new favorites_api_1.FavoritesApi(alfrescoApi);
        this.sitesApi = new sites_api_1.SitesApi(alfrescoApi);
        this.activitiesApi = new activities_api_1.ActivitiesApi(alfrescoApi);
        this.preferencesApi = new preferences_api_1.PreferencesApi(alfrescoApi);
        this.groupsApi = new groups_api_1.GroupsApi(alfrescoApi);
    }
