...
class ContentClient extends alfrescoApiClient_1.AlfrescoApiClient {
    constructor(config, servicePath, httpClient) {
        super(undefined, httpClient);
        this.className = 'ContentClient';
        this.setConfig(config, servicePath);
    }
    setConfig(config, servicePath) {
        this.config = config;
