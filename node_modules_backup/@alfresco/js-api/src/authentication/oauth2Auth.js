...
class Oauth2Auth extends alfrescoApiClient_1.AlfrescoApiClient {
    ...
    isPublicUrl() {
        ...
        if (Array.isArray(publicUrls)) {
            return publicUrls.length > 0 &&
                publicUrls.some((urlPattern) => path_matcher_1.PathMatcher.match(window.location.href, urlPattern));
        }
        return false;
    }
    ...
    pollingRefreshToken() {
        this.refreshTokenIntervalPolling = setInterval(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
    ...
    exchangeTicketListener(alfrescoApi) {
        this.on('token_issued', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
