...
var ContentClient = (function (_super) {
    ...
    function ContentClient(config, servicePath, httpClient) {
    ...
    ContentClient.prototype.changeHost = function () {
        ...
        this.basePath = "".concat(this.config.hostEcm, "/").concat(this.config.contextRoot).concat(this.servicePath);
    };
...
//# sourceMappingURL=../../../src/contentClient.js.map