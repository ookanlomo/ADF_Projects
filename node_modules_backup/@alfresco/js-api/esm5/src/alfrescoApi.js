...
var AlfrescoApi = (function () {
    function AlfrescoApi(config, httpClient) {
    ...
    AlfrescoApi.prototype.clientsFactory = function () {
        if (!this.contentPrivateClient) {
            this.contentPrivateClient = new ContentClient(this.config, "/api/".concat(this.config.tenant, "/private/alfresco/versions/1"), this.httpClient);
        }
        else {
            this.contentPrivateClient.setConfig(this.config, "/api/".concat(this.config.tenant, "/private/alfresco/versions/1"));
        }
        if (!this.contentClient) {
            this.contentClient = new ContentClient(this.config, "/api/".concat(this.config.tenant, "/public/alfresco/versions/1"), this.httpClient);
        }
        else {
            this.contentClient.setConfig(this.config, "/api/".concat(this.config.tenant, "/public/alfresco/versions/1"));
        }
        if (!this.authClient) {
            this.authClient = new ContentClient(this.config, "/api/".concat(this.config.tenant, "/public/authentication/versions/1"), this.httpClient);
        }
        else {
            this.authClient.setConfig(this.config, "/api/".concat(this.config.tenant, "/public/authentication/versions/1"));
        }
        if (!this.searchClient) {
            this.searchClient = new ContentClient(this.config, "/api/".concat(this.config.tenant, "/public/search/versions/1"), this.httpClient);
        }
        else {
        ...
        if (!this.gsClient) {
            this.gsClient = new ContentClient(this.config, "/api/".concat(this.config.tenant, "/public/gs/versions/1"), this.httpClient);
        }
        else {
