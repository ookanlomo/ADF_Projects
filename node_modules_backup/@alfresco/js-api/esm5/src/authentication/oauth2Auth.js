...
var Oauth2Auth = (function (_super) {
    ...
    function Oauth2Auth(config, alfrescoApi, httpClient) {
        var _this = _super.call(this, undefined, httpClient) || this;
    ...
    Oauth2Auth.prototype.getProfile = function () {
    ...
    Oauth2Auth.prototype.isPublicUrl = function () {
        ...
        if (Array.isArray(publicUrls)) {
            return publicUrls.length > 0 &&
                publicUrls.some(function (urlPattern) { return PathMatcher.match(window.location.href, urlPattern); });
        }
        return false;
    };
