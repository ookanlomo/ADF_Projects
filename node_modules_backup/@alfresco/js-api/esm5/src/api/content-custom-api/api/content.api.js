...
var ContentApi = (function (_super) {
    ...
    ContentApi.prototype.getVersionRenditionUrl = function (nodeId, versionId, encoding, attachment, ticket) {
        return this.apiClient.basePath + '/nodes/' + nodeId + '/versions/' + versionId +
            '/renditions/' + encoding + '/content' +
            '?attachment=' + (attachment ? 'true' : 'false') +
            this.apiClient.getAlfTicket(ticket);
    };
    ContentApi.prototype.getVersionContentUrl = function (nodeId, versionId, attachment, ticket) {
        return this.apiClient.basePath + '/nodes/' + nodeId +
