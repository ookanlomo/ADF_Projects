...
var SitesApi = (function (_super) {
    ...
    SitesApi.prototype.createSiteGroupMembership = function (siteId, siteMembershipBodyCreate, opts) {
        throwIfNotDefined(siteId, 'siteId');
        throwIfNotDefined(siteMembershipBodyCreate, 'siteMembershipBodyCreate');
        opts = opts || {};
        var postBody = siteMembershipBodyCreate;
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/sites/{siteId}/group-members', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, SiteGroupEntry);
    };
    SitesApi.prototype.listSiteGroups = function (siteId, opts) {
        throwIfNotDefined(siteId, 'siteId');
        opts = opts || {};
        var postBody = null;
        var pathParams = {
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/sites/{siteId}/group-members', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, SiteGroupPaging);
    };
    SitesApi.prototype.getSiteGroupMembership = function (siteId, groupId, opts) {
        throwIfNotDefined(siteId, 'siteId');
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/sites/{siteId}/group-members/{groupId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, SiteGroupEntry);
    };
    SitesApi.prototype.updateSiteGroupMembership = function (siteId, groupId, siteMembershipBodyUpdate, opts) {
        throwIfNotDefined(siteId, 'siteId');
        throwIfNotDefined(groupId, 'groupId');
        throwIfNotDefined(siteMembershipBodyUpdate, 'siteMembershipBodyUpdate');
        opts = opts || {};
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/sites/{siteId}/group-members/{groupId}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, SiteGroupEntry);
    };
    SitesApi.prototype.deleteSiteGroupMembership = function (siteId, groupId) {
        throwIfNotDefined(siteId, 'siteId');
        throwIfNotDefined(groupId, 'groupId');
        var postBody = null;
        var pathParams = {
