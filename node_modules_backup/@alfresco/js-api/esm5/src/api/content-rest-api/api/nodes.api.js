...
var NodesApi = (function (_super) {
    ...
    NodesApi.prototype.requestDirectAccessUrl = function (nodeId) {
        throwIfNotDefined(nodeId, 'nodeId');
        var pathParams = {
            'nodeId': nodeId
        };
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/nodes/{nodeId}/request-direct-access-url', 'POST', pathParams, {}, {}, {}, null, contentTypes, accepts, DirectAccessUrlEntry);
    };
    return NodesApi;
}(BaseApi));
export { NodesApi };
