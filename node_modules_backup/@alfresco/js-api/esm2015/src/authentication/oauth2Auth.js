...
export class Oauth2Auth extends AlfrescoApiClient {
    constructor(config, alfrescoApi, httpClient) {
    ...
    checkFragment(nonceKey, externalHash) {
    ...
    isPublicUrl() {
        ...
        if (Array.isArray(publicUrls)) {
            return publicUrls.length > 0 &&
                publicUrls.some((urlPattern) => PathMatcher.match(window.location.href, urlPattern));
        }
        return false;
    }
    ...
    pollingRefreshToken() {
        this.refreshTokenIntervalPolling = setInterval(() => __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    exchangeTicketListener(alfrescoApi) {
        this.on('token_issued', () => __awaiter(this, void 0, void 0, function* () {
            const authContentApi = new AuthenticationApi(alfrescoApi);
...
Oauth2Auth.DEFAULT_USER_INFO_ENDPOINT = '/protocol/openid-connect/userinfo';
